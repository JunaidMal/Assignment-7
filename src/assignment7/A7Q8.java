...
public class A7Q8 {
    ...
    public static void main(String[] args) {
        // may 31st is used to test the method "season"
        season(6, 31);

    }
    // Procedure type method that takes an integer in for month and day then uses it to find the season the date is within

    public static void season(int month, int day) {
        // Junary and February are Winter throughout those months
        if (month < 3 && month > 0) {
